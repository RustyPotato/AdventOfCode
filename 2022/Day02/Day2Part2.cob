...
AddEntry.
    ...
    IF (TheirMove = "B" AND MyMove = "X") OR
       (TheirMove = "A" AND MyMove = "Y") OR
       (TheirMove = "C" And MyMove = "Z")
        COMPUTE MatchScore = MatchScore + 1
    END-IF
    IF (TheirMove = "C" AND MyMove = "X") OR
       (TheirMove = "B" AND MyMove = "Y") OR
       (TheirMove = "A" And MyMove = "Z")
        COMPUTE MatchScore = MatchScore + 2
    END-IF
    IF (TheirMove = "A" AND MyMove = "X") OR
       (TheirMove = "C" AND MyMove = "Y") OR
       (TheirMove = "B" And MyMove = "Z")
        COMPUTE MatchScore = MatchScore + 3
    END-IF
